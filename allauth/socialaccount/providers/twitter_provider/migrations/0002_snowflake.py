...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('twitter_provider_twitteraccount', 'social_id', self.gf('django.db.models.fields.BigIntegerField')(unique=True))


    def backwards(self, orm):
        
        # Changing field 'TwitterAccount.social_id'
        db.alter_column('twitter_provider_twitteraccount', 'social_id', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True))
