...
from allauth.socialaccount.providers.h_provider_provider.client import OAuth
from allauth.socialaccount.providers.h_provider_provider.views import (OAuthAdapter,
                                                         OAuthLoginView,
                                                         OAuthCallbackView)
