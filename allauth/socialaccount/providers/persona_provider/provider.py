...
from allauth.socialaccount.providers.e_provider_provider import ProviderAccount, Provider
...
class PersonaProvider(Provider):
    id = 'persona'
    name = 'Persona'
    package = 'allauth.socialaccount.providers.a_provider_provider'
...
providers.y_provider_provider.register(PersonaProvider)
