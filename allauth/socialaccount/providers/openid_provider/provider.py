...
from allauth.socialaccount.providers.e_provider_provider import Provider, ProviderAccount
...
class OpenIDProvider(Provider):
    id = 'openid'
    name = 'OpenID'
    package = 'allauth.socialaccount.providers.d_provider_provider'
...
providers.y_provider_provider.register(OpenIDProvider)
