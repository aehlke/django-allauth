...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('openid_provider_openidaccount', (
        ...
        db.send_create_signal('openid_provider', ['OpenIDAccount'])

        # Adding model 'OpenIDStore'
        db.create_table('openid_provider_openidstore', (
        ...
        db.send_create_signal('openid_provider', ['OpenIDStore'])

        # Adding model 'OpenIDNonce'
        db.create_table('openid_provider_openidnonce', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('server_url', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal('openid_provider', ['OpenIDNonce'])


    def backwards(self, orm):
        
        # Deleting model 'OpenIDAccount'
        db.delete_table('openid_provider_openidaccount')

        # Deleting model 'OpenIDStore'
        db.delete_table('openid_provider_openidstore')

        # Deleting model 'OpenIDNonce'
        db.delete_table('openid_provider_openidnonce')
